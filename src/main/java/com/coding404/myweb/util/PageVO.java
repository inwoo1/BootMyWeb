...
public class PageVO {
	...
	private List<Integer> pageList; //타임리프에서는 향상된 for문을 제공하기때문에 페이지번호목록을 리스트에 저장
	
	
	//생성자 - pageVO는 생성될때 반드시 Criteria와 전체게시글 수를 받음.
	public PageVO(Criteria cri, int total) {
		...
		//1.끝 페이지 계산
		//page가 5 라면  -> 끝페이지 번호 10
		//page가 15 라면 -> 끝페이지 번호 20
		...
		//4.실제 끝번호를 다시 결정
		//141게시글 조회 = 1~10조회시 끝페이지 10
		//11~20 조회시 끝페이지20, 실제끝 15
